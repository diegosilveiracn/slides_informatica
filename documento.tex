...
\begin{frame}
	...
	\begin{alertblock}{Atenção}
		Não desligar o computador diretamente do botão de liga/desliga.
	\end{alertblock}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Chats online: Whatsapp, Telegram, Google Meet e Microsoft Teams;
		\item Redes sociais: Facebook, Instagram, X e LinkedIn;
		\item Comércio eletrônico: Amazon, Mercado Livre, OLX, Shopee e iFood;
