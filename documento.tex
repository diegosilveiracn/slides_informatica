...
\begin{frame}
	...
	\begin{block}{Defini\c cão}
		É um periférico de entrada que é utilizado sobre uma superfície plana responsável pela movimenta\c cãi do cursor na tela.
	\end{block}\vfill
...
\begin{frame}
	...
	\begin{block}{Defini\c cão}
		É um periférico de entrada,  semelhante ao mouse,  que o utilizado para manipular uma esfera responsável pela movimenta\c cãi do cursor na tela.
	\end{block}\vfill
